...
<head>
  ...
  <link rel="icon" type="image/png" sizes="96x96" href="assets/images/pngaaa.com-21504.png">
...
<body>
  ...
  <?php $string = $_GET['string'];
        $sort = "SELECT * FROM books WHERE title LIKE '%$string%' OR author LIKE '%$string%'"; 
   ?>
   ...
   <table class="table table-hover">
     ...
     while ($r = mysqli_fetch_assoc($result)) {
       echo '
         ...
         <td> ' . $r['status'] . '      </td>
         <td> 
         <a class="text-info" href="?action_edit=edit&book_number='.$r['book_number'].'&string=' . $_GET['string'] . ' ">Edit</a> 
         <a class="text-warning ml-3" href="?action_delete=delete&book_number='.$r['book_number'].'&string=' . $_GET['string'] . ' ">Delete</a> 
         </td>
       </tbody>
       ';
     }
